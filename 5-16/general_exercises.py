...
li = ["edabit", "flick", "eda", "bit"]
# li = [False, False, "flick", "sheep", "flick"]
...
#         break
#     li[x] = "True"
# for y in range(switchpoint, len(li)):
#         li[y] = "False"
...
#     words_list = words_list[0] + "ed " + words_list[1]
#     print(words_list)



# verbify("Salt water")
# verbify("cheese burger")
...
pineapple_wiki_list = pineapple_wiki.split(" ")

pineapple_wiki_list_filtered = []

for word in pineapple_wiki_list:
    if len(word) > 2 and () 